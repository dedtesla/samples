 ...
 */
Ext.define('Buh.classes.field.GbsNumberField',
    {
        extend: 'Ext.form.field.Number',
        alias: 'widget.gbsnumberfield',
        currencySymbol: null,
        ...
        initComponent: function () {
            ...
            } else if (this.allowDecimals && this.thousandSeparator == ' ') {
                this.thousandSeparator = ' ';
            }
        ...
        setValue: function (value) {
            ...
            // this.setValue(value != null ? value.toString().replace('.', this.decimalSeparator) : value);
