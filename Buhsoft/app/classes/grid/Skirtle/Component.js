 ...
 */
Ext.define('Buh.classes.grid.Skirtle.Component', {
    alias: 'widget.componentcolumn',
    extend: 'Ext.grid.column.Column',
    requires: ['Buh.classes.grid.Skirtle.CTemplate', 'Buh.classes.container.Vertical'],
    ...
    createTemplate: function(tpl) {
        return tpl && tpl.isTemplate
            ? tpl
            : Ext.create('Buh.classes.grid.Skirtle.CTemplate', tpl || ['{', this.dataIndex ,'}']);
    },
