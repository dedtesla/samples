Ext.define('Buh.model.bookbuy.Sale', {
    ...
    fields: [
        ...
        'inn',// varchar(15) comment 'ИНН продавца',
        'kpp',// varchar(15) comment 'КПП продавца',
        ...
        'sumndsb',// decimal (15,2) unsigned default 0, Стоимость продаж, освобожденных от налога
        ...
        'sumz',// decimal (15,2) unsigned default 0,
        'sumndsz',// decimal (15,2) unsigned default 0,
        'nm_p',// varchar(250) comment 'название покупателя',
        'inn_p',// varchar(15) comment 'ИНН покупателя',
        'kpp_p',// varchar(15) comment 'КПП покупателя',
        'org_inn_kpp',
